...
<div class="box-header with-border">
	...
	<div class="panel-heading">Pengembalian
	...
	<form action="{{route('kembali.update',$kembali->id)}}" method="post">
		...
		<div class="form-group">
			<label class="control-lable">Tanggal Kembali</label>
				<input type="date" name="tanggal" class="form-control">{{$kembali->tanggal_kembali}}</div>

		<div class="form-group">
			<label class="control-lable">Jumlah Hari</label>
				<input type="text" name="nama" class="form-control"  value="{{$kembali->jumlah_hari}} "></div>
