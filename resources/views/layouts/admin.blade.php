...
<div class="wrapper">
  <header class="main-header">
    <a href="{{ url('/') }}" class="logo">
      ...
      <span class="logo-lg"><b>Rental Kamera</b></span>
    </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="{{route('kamera.index')}}">
            <i class="fa fa-users"></i> <span>Kamera</span>
          </a>
        </li>
        <li>
          <a href="{{route('sewa.index')}}">
            <i class="fa fa-money"></i> <span>Detail Sewa</span>
          </a>
        </li>
        <li>
          <a href="{{route('kembali.index')}}">
            <i class="fa fa-money"></i> <span>Pengembalian</span>
          </a>
        </li>
        <li>
          <a href="{{route('user.index')}}">
            <i class="fa fa-money"></i> <span>Karyawan</span>
          </a>
        </li>
      </ul>
    </section>
...
{{--     <section class="content-header">
 ...
 --}}    <section class="content">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2018 <a href="http://wekuk.com">Sella Rostiana</a>.</strong> All rights reserved.
  </footer>
</div>
